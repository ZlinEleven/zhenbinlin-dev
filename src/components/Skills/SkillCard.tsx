...
const SkillCard = ({ title, icon, isActive, onClick }: SkillCardProps) => {
  return (
    <div onClick={onClick}>
      <div
        className={`flex flex-col items-center p-5 md:p-10 m-[0.675rem] md:m-[20px] cursor-pointer
        ...
        rounded-[0.65rem] border-solid border-[3px] border-[#704cf2] bg-[#151146] duration-1000 text-white`}
      >
