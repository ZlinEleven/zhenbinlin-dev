    ...
    return (
        <div name='about' className="w-full h-screen bg-[#0a192f] justify-center">
            <div className='max-w-[1000px] mx-auto justify-center'>
                ...
                <Link to="experience" spy={true} smooth={true} offset={-30} duration={500}>
                    <div className='max-w-[1000px] mx-auto flex justify-center'>
                        <button className='w-10/12 hover:w-11/12 text-white group border-2 px-6 py-3 my-6 flex items-center justify-center hover:bg-pink-600 duration-700'>View my work
