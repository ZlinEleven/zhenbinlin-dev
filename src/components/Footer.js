    ...
    return (
        <div className='flex h-60 bg-[#0a192f] text-[#ccd6f6] justify-evenly items-center'>
            ...
            <div className='grid grid-cols-2 gap-6'>
                ...
                <FooterCards text="Discord" icon={<ImProfile color='#fae1b2' size='38' className='py-2 mt-[-10px]' />} link='https://drive.google.com/file/d/1JbtAwQlNt0Xo2QTBeJjw2I7yPyZuMwVt/view?usp=sharing'/>
            </div>
        </div>
    )
}
