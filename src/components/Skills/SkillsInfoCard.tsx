    ...
    <div className="grid grid-cols-3 md:gap-10 mt-[1.25rem]">
      {skills.map((skill) => (
        <div key={skill.name} className="group mt-3 md:mt-0 mb-6 md:mb-0">
          ...
          >
            <img src={skill.icon} alt={skill.name} className="w-8 md:w-16" />
          ...
          >
            <div className="flex flex-col w-full items-center">
              <p className="text-[0.65rem] md:text-[1.3rem] font-[500] text-[#dd8cfa] mb-2">
                {skill.percentage}%
              </p>
              <div className="w-[90%] mx-auto bg-gray-200 rounded-full h-[0.325rem] md:h-[0.65rem]">
                <div
                  className="bg-[#7c5fe6] h-[0.325rem] md:h-[0.65rem] rounded-full"
