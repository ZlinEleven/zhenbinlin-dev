...
const experiences = [
    ...
    },
    {
        ...
        desc: "Worked in a team of 6 to develop and implement an AI-leveraged learning tool for students. Designed and built backend microservice using Express, Postman and Firebase Cloud Functions. Built out initial frontend with React and Next consisting of user login, sessions and flashcards screen.",
        icon: <MdOutlineWork />
    },
    {
